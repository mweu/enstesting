...
public class MultipleChoicesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multiple_choices_question);mainLabel = (EditText) findViewById(R.id.selectedExam);

        mainLabel.setKeyListener(null);
        ESSStaticVariables.examAction.startExam(ESSStaticVariables.examTimeInSeconds, MultipleChoicesActivity.this);
        ...
        final LinearLayout selections = (LinearLayout) findViewById(R.id.groupradio);
        ...
        try {
            String url = ESSStaticVariables.BACKEND_SCHOOL_URL + "/schooltransactions/getExamAnswers/"+
                    ...
                    ESSStaticVariables.session.getTenantId() +"/" + QuestionType.MULTIPLE_CHOICES;
            ESSStaticVariables.examAction.makeGETRequest(url, MultipleChoicesActivity.this,
                    new DSCallBack<JSONObject, String>() {
                        ...
                        public JSONObject onResponse(String response) throws Exception {
                            ...
                            for(int i=0; i<data.length();i++) {
                                CheckBox button = new CheckBox(MultipleChoicesActivity.this);
                                button.setId(i+1);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new AlertDialog.Builder(MultipleChoicesActivity.this)
    ...
    private void submitQuestion(LinearLayout selections){
        try {
            String url = ESSStaticVariables.BACKEND_SCHOOL_URL + "/schooltransactions/submitMultipleQuestion/"+
                    ESSStaticVariables.currentQuestion.getString("index") + "/" +
                    ESSStaticVariables.termSession.getTermId();
            JSONArray selectionsArray = new JSONArray();
            int count = selections.getChildCount();
            for (int i = 0; i < count; i++) {
                View v = selections.getChildAt(i);
                if (v instanceof CheckBox) {
                    if(((CheckBox) v).isChecked()){
                        JSONObject obj = new JSONObject();
                        JSONObject questionSelection = (JSONObject) selectionValues.get(i).getValue();
                        Log.e("","Selection " + i);
                        obj.put("value", questionSelection.getString("index"));
                        selectionsArray.put(obj);
                    }
                }
            }
            Log.e("",String.valueOf(selectionsArray.length()));
            /*DSParams value = null;*/
            /*try{
            ...
            if(selectionsArray!=null){
                ...
                params.put("selections", selectionsArray.toString());
                ESSStaticVariables.examAction.makePOSTRequest(MultipleChoicesActivity.this,
    ...
    private void getAnswers(final LinearLayout selections){
        try {
            String url = ESSStaticVariables.BACKEND_SCHOOL_URL + "/schooltransactions/getMultipleAnswerSelection/"+
                    ESSStaticVariables.currentQuestion.getString("index") + "/" +
                    ESSStaticVariables.examSession;
            new DSAction<JSONObject, String>().makeGETRequest(url, MultipleChoicesActivity.this,
                    new DSCallBack<JSONObject, String>() {
                        @Override
                        public JSONObject onResponse(String response) throws Exception {
                            Log.e("", response);
                    ...
                    new DSCallBack<JSONObject, String>() {
                        ...
                        public JSONObject onResponse(String response) throws Exception {
                            if(Boolean.valueOf(response)){
                                Toast.makeText(MultipleChoicesActivity.this, "Exam was submited successfully", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(MultipleChoicesActivity.this, MainActivity.class);
                                startActivity(intent);
                            }else{
                                Toast.makeText(MultipleChoicesActivity.this, "Failed", Toast.LENGTH_SHORT).show();
                            }
                            return null;
                        }
            ...
            new DSAction<JSONObject, String>().makeGETRequest(url, MultipleChoicesActivity.this,
                    new DSCallBack<JSONObject, String>() {
                        ...
                        public JSONObject onResponse(String response) throws Exception {
                            ...
                            switch(type){
                                case BOOLEAN:
                                    Intent intent = new Intent(MultipleChoicesActivity.this, BooleanQuestionActivity.class);
                                    startActivity(intent);
                                    break;
                                case DESCRIPTIVE:
                                    Intent intentDescriptive = new Intent(MultipleChoicesActivity.this, DescriptiveQuestionActivity.class);
                                    startActivity(intentDescriptive);
                                    break;
                                case MULTIPLE_CHOICES:
                                    Intent intentMultiple = new Intent(MultipleChoicesActivity.this, MultipleChoicesActivity.class);
        ...
        try {
            new DSAction<JSONObject, String>().makeGETRequest(url, MultipleChoicesActivity.this,
                    new DSCallBack<JSONObject, String>() {
                        @Override
                        public JSONObject onResponse(String response) throws Exception {
                            Log.e("Response Received",response);
                            if(response !=null){
                                try {
                                    JSONObject question = new JSONObject(response);
                                    if(question!=null){
